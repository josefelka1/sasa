...
class Request {
    ...
    generate_headers() {
        this.headers = [];
        const version = random_int(130, 136);
        ...
        switch (version) {
            ...
            case 136:
                brandValue = `\"Chromium\";v=\"${version}\", \"Google Chrome\";v=\"${version}\", \"Not.A/Brand\";v=\"99\"`;
                fullVersion = `${version}.0.${random_int(6610, 6790)}.${random_int(10, 100)}`;
                brandValue = `\"Chromium\";v=\"${fullVersion}\", \"Google Chrome\";v=\"${fullVersion}\", \"Not.A/Brand\";v=\"99.0.0.0\"`;
            default:
                brandValue = `\"Not/A)Brand\";v=\"8\", \"Chromium\";v=\"${version}\", \"Google Chrome\";v=\"${version}\"`;
                fullVersion = `${version}.0.${random_int(6610, 6790)}.${random_int(10, 100)}`;
                versionList = `\"Not/A)Brand\";v=\"8.0.0.0\", \"Chromium\";v=\"${fullVersion}\", \"Google Chrome\";v=\"${fullVersion}\"`;
        ...
        console.log(`
           ...
           ${'_o8888888888'.yellow}${'88'.grey.bold}${'K_]'.bgBlack.white.bold}${'888888o'.grey.bold}
                   ...
                   ${'_=oooooooo'.yellow.bold}${'8888888888888888'.white.bold}${'88'.white}
                    ${'_o88=8888='.yellow.bold}=~${'88888888'.yellow.bold}===8${'888_'.white}    ${'@PENGUINZ'.cyan.underline} # ${colors.dim.bold(new Date().toLocaleDateString("en"))}
                    ${'~'.yellow.bold}   ${'=~~'.yellow.bold} ${'_o88888888='.yellow.bold}      ~~~      ${'JS PENGUIN'.bold} [${'v1.5'.underline}]
                            ${'~ o8=~88=~'.yellow.bold}           
